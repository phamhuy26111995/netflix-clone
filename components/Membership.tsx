...
function Membership() {
  ...
  return (
    <React.Fragment>
        <div className="mt-6 grid grid-cols-1 gap-x-4 border px-4 md:grid-cols-4 md:border-x-0 
        ...
        <div className="col-span-3">
            ...
            <div className="flex flex-col justify-between pt-4 md:flex-row md:pd-0">
                <div>
                    <p>
